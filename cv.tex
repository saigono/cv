...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
	\textbf{\Large Danil Ineev} & \textbf{May 16, 2023} \\
...
\begin{itemize}
	\item
	      \textbf{Software development}: 10+ years of professional, academic and hobby projects experience.
	\item
	      \textbf{Building backend services}: designed and build multiple backend systems, from video transcoding and betting to cybersecurity data flows and tax operations.
	\item
	      \textbf{Multiple domains experience}: over the length of my career I've worked in many areas: desktop apps, backend and frontend web software,
	      and video streaming. Even though my main programming language is Python, I've also written in Java, Typescript, Ruby, and many more.
\end{itemize}
...
\begin{itemize}
	...
	\item
	      ...
	      \begin{itemize}
		      \resitem{Participated in the development of several tax-related projects, both internal and external.}
		      \resitem{Made important contributions towards establishing a user-oriented software engineering team.}
	...
	\item
	      ...
	      \begin{itemize}
		      ...
		      \resitem{Worked on multiple other AWS In-Memory consoles.}
