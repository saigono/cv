...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
	\textbf{\Large Danil Ineev} & \textbf{May 18, 2023} \\
...
\begin{itemize}
	...
	\item
		  Improved the efficiency of the SDLC by introducing new customer requests assessment process, writing better tooling, updating the feature design documentation templates and review process
	\item 
...
\begin{itemize}
	\item
	      \ressubheading{Stripe}{Remote, Ireland}{Software Engineer}{Jun. 2022 - }
	      \begin{itemize}
	      ...
	      \end{itemize}
	\item
		\ressubheading{Codereview}{Remote}{Technical mentor}{Dec. 2022 - }
		\begin{itemize}
			\resitem{Mentored software developers to be more competitive on job market.}
			\resitem{Driven and participated in multiple marketing activities, including webinars, mock interviews and many more.}
		\end{itemize}
	\item
