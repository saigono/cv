...
\textbf{\Large Danil Ineev} & \textbf{September 22, 2022} \\
...
\item
	\textbf{Building data acquiring systems}: designed and build multiple systems that gathers, normalizes and distributes cybersecurity data.
\item
...
\begin{itemize}
\item
	\ressubheading{Amazon}{Dublin, Ireland}{Software Engineer}{Jan. 2021 - Jun. 2022}
	\begin{itemize}
		\resitem{Led the development of AWS Timestream console.}
		\resitem{Worked on multiple other AWS In-Memory consoles.}
		\resitem{Participated in launch of Amazon MemoryDB.}
	\end{itemize}
...
\item
	...
	\begin{itemize}
		...
		\resitem{Designed and lead the development of a few internal projects.}
